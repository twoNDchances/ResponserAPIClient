...
$('#iptablesResponserCreationForm input, #iptablesResponserCreationForm textarea').on('input', updateJsonPreview)
...
$(document).ready(function () {
    ...
    $('#responserCreationButton').on('click', function (event) {
        ...
        const iptablesResponserCreationJSONForm = {
        ...
        callAPI(
            ...
            JSON.stringify(iptablesResponserCreationJSONForm)
        )
    })
})