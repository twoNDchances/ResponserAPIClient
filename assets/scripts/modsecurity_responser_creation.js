...
$('#modsecurityResponserCreationForm input, #modsecurityResponserCreationForm textarea').on('input', updateJsonPreview)
...
$(document).ready(function () {
    ...
    $('#responserCreationButton').on('click', function (event) {
        ...
        callAPI(
            ...
            JSON.stringify(modsecurityResponserCreationJSONForm)
        )
    })
})